...
def build_claude_task(raw_prompt, tools_kwargs: dict | None = None) -> str:
    ...
    return (
        ...
        "- Investigate the root cause before editing. Inspect the relevant implementation and existing tests.\n"
        "- Implement a complete fix for the reported issue rather than a narrow workaround.\n"
        ...
        "- Do not commit.\n"
        "- Run the relevant tests after implementing the fix. If they fail, diagnose the failure and iterate until "
        "the relevant tests pass.\n"
        "- After the tests pass, review the fix for directly related edge cases and summarize the root cause, "
